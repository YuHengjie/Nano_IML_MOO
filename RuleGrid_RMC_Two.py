...
larger_coeff_limit = 0.8112485613741695
larger_import_limit = 0.3328762987662691
...
# %%
rule_C_B_sort_C = {'[25, 37.5]':0,'[25, 62.5]':1, '[25, 75.0]':2,
                   '(37.5, 200]':3,'(37.5, 75.0]':4, '(62.5, 200]':5, 
                   '(75.0, 200]':6,
       }
...
# %%
C_B_interval_simply_B = pd.DataFrame({'Raw interval':['[4.07, 107.75]', '[4.07, 39.635]',
                                    '[4.07, 41.785]', '[4.07, 45.705]', '[4.07, 48.595]',
                                    '[4.07, 73.47]' ,'(39.635, 200.84]','(45.705, 107.75]',
                                      '(45.705, 200.84]', '(102.145, 200.84]', '(107.75, 200.84]',                                                                                                                                                                                                                                                                                                            
...
# %%
rule_C_H_sort_C = {'[25, 75.0]':1,'(37.5, 200]':5,'(75.0, 150.0]':6,
       }
...
# %%
C_H_interval_simply_H = pd.DataFrame({'Raw interval':['(220.665, 933.73]', '(253.07999, 900.76498]', '(363.47, 933.73]'],})
# only three intervals, no need to simplify
C_H_interval_simply_H.loc[0:,'Simply interval'] = simple_interval_func(C_H_interval_simply_H['Raw interval'].values[0:],
                                                                       threshold=0) # threshold=(H_range[1]-H_range[0])*0.05
...
# %%
rule_C_Z_sort_C = {'[25, 150.0]':0,'(150.0, 200]':1,
       }
...
# %%
# no need to simplify
C_Z_interval_simply_Z = pd.DataFrame({'Raw interval':['[-32.77, 5.565]','(-25.835, 26.17]',
                                                      '(-13.03, 23.25]','(5.565, 44.07]',
                                     ],})
...
plt.legend(bbox_to_anchor=(6.5, 1), loc='upper right', 
            borderaxespad=0,labelspacing=0.8, scatterpoints=1,
            frameon = False, ncol=1
          )
...
# %%
rule_C_T_sort_C = {'[25, 75.0]':0,'(37.5, 200]':1, '(75.0, 200]':2,
                   '(150.0, 200]':3,
       }
...
# %%
C_T_interval_simply_T = pd.DataFrame({'Raw interval':['[12.97, 24.155]','[12.97, 31.95]',
                                   '[12.97, 37.02]','(13.07, 24.155]', '(24.155, 132.11]',
                                     '(31.95, 132.11]',
