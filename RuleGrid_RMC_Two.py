...
rule_C_B_sort_C = {'[25, 75.0]':0,'[25, 150.0]':1,
                   '(37.5, 200]':2, '(62.5, 200]':3, '(75.0, 200]':4,
                    '(150.0, 200]':5,
       }
...
# %%
C_B_interval_simply_B = pd.DataFrame({'Raw interval':['[4.07, 5.01]', '[4.07, 45.705]', '[4.07, 48.595]' ,
                                                    '[4.07, 56.85]', '[4.07, 92.805]','[4.07, 127.18999]' ,                                                                                                                                                                                                                                                                                                 
                                                    '(5.01, 15.31]', '(45.705, 200.84]',
                                                    '(73.47, 200.84]', '(92.805, 200.84]',
                                     ],})
...
# %%
C_B_interval_simply_B.to_excel('./Table/RMC_C_B_interval_simply_B.xlsx')
...
g = sns.scatterplot(
    ...
    size="Importance",sizes=(30,250*rule_map_C_B_importance.max().max()/larger_import_limit),
    ax=ax, palette = palette,hue_norm=(-larger_coeff_limit,larger_coeff_limit),
)

plt.xticks(rotation=45,ha='right')
plt.xlim(-0.5,len(rule_C_B_sort_C.keys())-0.5)
plt.ylim(-0.5,len(list(rule_C_B_sort_B))-0.5)
...
fig.savefig("./Image/Rule_Map_RMC_C_B.jpg",dpi=600,bbox_inches='tight')




# %%
# %% 2、 for rule map of C and H
...
# %%
C_H_interval_simply_H = pd.DataFrame({'Raw interval':['[197, 253.07999]', '[197, 840.285]',
                                                    '(220.665, 933.73]', '(253.07999, 933.73]', 
                                                      '(415.67999, 933.73]','(840.285, 933.73]', 
                                                    ],})
...
# %%
#C_H_interval_simply_H.to_excel('./Table/RMC_C_H_interval_simply_H.xlsx')
...
g = sns.scatterplot(
    ...
    size="Importance",sizes=(30,250*rule_map_C_H_importance.max().max()/larger_import_limit),
    ax=ax, palette = palette,hue_norm=(-larger_coeff_limit,larger_coeff_limit),
)

plt.xticks(rotation=45,ha='right')

plt.xlim(-0.5,len(rule_C_H_sort_C.keys())-0.5)
plt.ylim(-0.5,len(list(rule_C_H_sort_H))-0.5)
...
fig.savefig("./Image/Rule_Map_RMC_C_H.jpg",dpi=600,bbox_inches='tight')


# %%
# %% 3、 for rule map of C and Z
...
rule_C_Z_sort_C = {'[25, 37.5]':0, '[25, 75.0]':1,'[25, 150.0]':2,
                    '(37.5, 200]':3, '(75.0, 200]':4,'(150.0, 200]':5,
                      }
...
# %%
# no need to simplify
C_Z_interval_simply_Z = pd.DataFrame({'Raw interval':[ '[-32.77, -16.015]','[-32.77, -13.03]',
                                                        '[-32.77, -11.7]', '[-32.77, 26.17]',
                                                        '(-13.03, 1.595]', '(1.595, 44.07]', 
                                                        '(5.565, 44.07]',  '(23.25, 26.17]', '(26.17, 44.07]',
...
# %%
C_Z_interval_simply_Z.to_excel('./Table/RMC_C_Z_interval_simply_Z.xlsx')
...
g = sns.scatterplot(
    ...
    size="Importance",sizes=(30,250*rule_map_C_Z_importance.max().max()/larger_import_limit),
    ax=ax, palette = palette,hue_norm=(-larger_coeff_limit,larger_coeff_limit),
)

plt.xticks(rotation=45,ha='right')

plt.xlim(-0.5,len(rule_C_Z_sort_C.keys())-0.5)
plt.ylim(-0.5,len(list(rule_C_Z_sort_Z))-0.5)
...
fig.savefig("./Image/Rule_Map_RMC_C_Z.jpg",dpi=600,bbox_inches='tight')



# %%
# %% 4、 for rule map of C and T
...
# %%
rule_C_T_sort_C = {
                    '[25, 37.5]':0, '[25, 75.0]':1, '[25, 150.0]':2,
                    '(37.5, 200]':3, '(62.5, 200]':4, '(75.0, 200]':5,
                    '(150.0, 200]':6,
       }
...
# %%
C_T_interval_simply_T = pd.DataFrame({'Raw interval':['[12.97, 13.07]',
                                    '[12.97, 16.785]', '[12.97, 24.155]', '[12.97, 27.04]', '[12.97, 28.685]',
                                    '[12.97, 37.02]','(13.07, 132.11]', '(14.68, 132.11]', '(16.785, 132.11]',
                                    '(21.72, 132.11]', '(21.72, 31.95]', '(24.155, 132.11]', '(31.95, 132.11]',
                                    '(32.42, 132.11]', '(37.02, 132.11]', '(73.455, 132.11]', 
                                    '(113.04, 132.11]' ,
...
# %%
C_T_interval_simply_T.to_excel('./Table/RMC_C_T_interval_simply_T.xlsx')
...
g = sns.scatterplot(
    ...
    size="Importance",sizes=(30,250*rule_map_C_T_importance.max().max()/larger_import_limit),
    ax=ax, palette = palette,hue_norm=(-larger_coeff_limit,larger_coeff_limit),
)

plt.xticks(rotation=45,ha='right')
plt.xlim(-0.5,len(rule_C_T_sort_C.keys())-0.5)
plt.ylim(-0.5,len(list(rule_C_T_sort_T))-0.5)
...
fig.savefig("./Image/Rule_Map_RMC_C_T.jpg",dpi=600,bbox_inches='tight')
