...
# %%
model_rule_number_RMC.to_excel('Rule_number_RMC.xlsx')
...
# %%
model_rule_number_RDW = pd.read_excel('Rule_number_RDW.xlsx',index_col=0)
model_rule_number_RDW

# %%
print('Rule number RMC:',model_rule_number_RMC['Rule number'].mean())
print('Rule number RDW:',model_rule_number_RDW['Rule number'].mean())
...
fig.savefig("./Image/RuleFit_rule_number_models.jpg",dpi=600,bbox_inches='tight')
...
# %%
rules_all.to_excel('Rules_all_RMC.xlsx')
...
fig.savefig("./Image/RuleFit_importance_feature_RMC.jpg",dpi=600,bbox_inches='tight')

# %%
importance_df['Model'] = 'RMC'
importance_df.to_excel('RMC_feature_importance.xlsx')
importance_df

# %%
importance_df_two_model = pd.read_excel('RDW_feature_importance.xlsx',index_col=0)
...
# %%
rule_number_importance = pd.DataFrame(columns=['Rule number','Importance'],index=range(4))
...
rule_number_importance.to_excel('RMC_number_importance.xlsx')
rule_number_importance

# %%
importance_number_two_model = pd.read_excel('RDW_number_importance.xlsx',index_col=0)
importance_number_two_model

# %%
new_row = {'Rule number': 5, 'Importance': 0,'Model': 'RDW'}
importance_number_two_model = importance_number_two_model.append(new_row, ignore_index=True)
importance_number_two_model
