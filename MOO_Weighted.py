...
# %%
Equal_weighted_49 = full_data.sort_values(['Equal-weighted'], ascending=[False]).iloc[0:49,:]
Equal_W_49_index = Equal_weighted_49.index
np.save("Equal_W_49_index.npy", Equal_W_49_index)
Equal_W_49_index
...
# %%
list1 = list(Equal_weighted_ten.index[0:6])
list2 = list(RDW_first_ten.index[0:6])
list3 = list(RMC_first_ten.index[0:6])
