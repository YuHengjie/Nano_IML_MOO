...
# %%
C_H_interval_simply_H = pd.DataFrame({'Raw interval':['[197, 220.665]', '[197, 263.34999]',
                                    '[197, 312.84999]', '[197, 363.47]' ,'[197, 543.41499]' ,
                                    '[197, 736.38501]', '(220.665, 933.73]' ,
                                    '(263.34999, 363.47]', '(263.34999, 415.67999]',
                                    '(263.34999, 933.73]', '(344.45, 736.38501]', '(344.45, 900.76498]',
                                    '(363.47, 900.76498]', '(363.47, 933.73]' ,'(390.5, 933.73]',
                                    '(415.67999, 933.73]', '(736.38501, 933.73]', '(840.285, 933.73]',
                                    '(900.76498, 933.73]',          
                                     ],})
...
# %%
C_H_interval_simply_H.to_excel('./Table/RDW_C_H_interval_simply_H.xlsx')
...
# %%
C_Z_interval_simply_Z = pd.DataFrame({'Raw interval':['[-32.77, -25.835]','[-32.77, -16.015]',
                                    '[-32.77, -13.03]','[-32.77, -11.6]', '[-32.77, -4.945]',
                                    '(-13.03, -9.325]','(-13.03, -4.945]' ,'(-13.03, 26.17]',
                                    '(-13.03, 35.27]' ,'(-13.03, 44.07]','(-11.6, 44.07]',
                                    '(-4.945, 44.07]', '(26.17, 35.27]',
                                    '(26.17, 44.07]', '(35.27, 44.07]' ,
                                     ],})
...
# %%
C_Z_interval_simply_Z.to_excel('./Table/RDW_C_Z_interval_simply_Z.xlsx')
...
# %%
rule_C_T_sort_C = {'[25, 37.5]':0,'[25, 150.0]':1, 
...
# %%
C_T_interval_simply_T = pd.DataFrame({'Raw interval':['[12.97, 13.07]', '[12.97, 29.155]',
                                    '[12.97, 38.345]','(13.07, 38.345]', '(13.07, 132.11]' ,
                                    '(14.68, 21.72]', '(19.155, 28.685]',
                                    '(28.685, 38.345]', '(32.04, 132.11]' ,'(38.345, 73.455]',
                                    '(38.345, 113.04]','(38.345, 132.11]' ,
                                     ],})
...
# %%
C_T_interval_simply_T.to_excel('./Table/RDW_C_T_interval_simply_T.xlsx')
...
# %%
C_B_interval_simply_B = pd.DataFrame({'Raw interval':['[4.07, 4.39]', '[4.07, 15.31]','[4.07, 27.46]', 
                                                    '[4.07, 45.705]','[4.07, 181.475]', '(4.39, 45.705]',
                                                    '(27.46, 45.705]','(31.38, 127.18999]','(92.805, 181.475]',
...
# %%
C_B_interval_simply_B.to_excel('./Table/RDW_C_B_interval_simply_B.xlsx')
...
g = sns.scatterplot(
    ...
    size="Importance",sizes=(10,250*rule_map_C_B_importance.max().max()/larger_import_limit),
    ax=ax, palette = palette,hue_norm=(-larger_coeff_limit,larger_coeff_limit),
)
