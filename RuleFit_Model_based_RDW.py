...
# %%
model_rule_number.to_excel('Rule_number_RDW_simple.xlsx')

# %%
rules_all.to_excel('Rules_all_RDW_simple.xlsx')
...
fig.savefig("./Image/RuleFit_importance_feature_RDW_simple.jpg",dpi=600,bbox_inches='tight')

# %%
importance_df['Model'] = 'RDW'
importance_df.to_excel('RDW_feature_importance_simple.xlsx')
importance_df
...
rule_number_importance.to_excel('RDW_number_importance_simple.xlsx')
rule_number_importance
