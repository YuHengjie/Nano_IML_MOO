...
larger_coeff_limit = 0.13996358578383838 
larger_import_limit = 0.06301131075933848 
...
# %%
rule_C_H_Z_sort_C = { '[25, 75.0]':0, '[25, 150.0]':1, '(37.5, 75.0]':2,
                    '(37.5, 200]':3,
                    }
...
# %%
C_H_Z_interval_simply_H = pd.DataFrame({'Raw interval':['[197, 363.47]', '(220.665, 933.73]', 
                                        '(263.34999, 344.45]' ,'(263.34999, 933.73]',
                                        '(276.06999, 363.47]', '(344.45, 933.73]', '(363.47, 933.73]',
                                     ],})
...
# %%
C_H_Z_interval_simply_H.to_excel('RDW_C_H_Z_interval_simply_H.xlsx')
...
# %%
C_H_Z_interval_simply_Z = pd.DataFrame({'Raw interval':['[-32.77, -11.6]', '[-32.77, -9.325]',
                                    '[-32.77, 5.565]', '[-32.77, 23.55]', '[-32.77, 26.17]' ,           
                                    '[-32.77, 30.97]', '(-25.835, -9.325]', '(-25.835, 44.07]',          
                                    '(-13.03, 5.565]' ,    
                                     ],})
...
# %%
C_H_Z_interval_simply_Z.to_excel('RDW_C_H_Z_interval_simply_Z.xlsx')
...
# %%
rule_C_T_Z_sort_C = { '(37.5, 150.0]':0, 
                    }
...
# %%
rule_C_T_Z_sort_T = { '(16.785, 132.11]':0, 
                    }
...
# %%
rule_C_T_Z_sort_Z = { '(-11.6, 26.17]':0, 
                    }
